...
// POST /batch must be registered before POST /:id to avoid Express routing conflicts
...
router.put('/:id', (req, res) => {
  ...
  const patch: Partial<Pick<notificationStore.NotificationPreference, 'channel' | 'enabled'>> = {};
